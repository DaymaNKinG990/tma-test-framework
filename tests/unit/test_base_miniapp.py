...
class TestBaseMiniAppInit:
    ...
    @allure.title("Successful initialization with valid url and config")
    @allure.description("Test successful initialization with valid url and config.")
    def test_init_with_valid_url_and_config(self, valid_config):
        """Test successful initialization with valid url and config."""
        with allure.step("Create BaseMiniApp instance"):
    ...
    @allure.title("Initialization with various valid URLs")
    @allure.description("Test initialization with various valid URLs.")
    def test_init_with_valid_urls(self, url, valid_config):
        """Test initialization with various valid URLs."""
        with allure.step(f"Create BaseMiniApp instance with URL: {url}"):
    ...
    @allure.title("BaseMiniApp rejects None config with ValueError")
    @allure.description("Test that BaseMiniApp rejects None config with ValueError.")
    def test_init_with_config_none_raises_value_error(self):
        """Test that BaseMiniApp rejects None config with ValueError."""
        with allure.step("Attempt to create BaseMiniApp with config=None"):
            with pytest.raises(ValueError, match="config is required"):
                BaseMiniApp("https://example.com/app", None)

    @allure.title("URL is saved as instance attribute")
    @allure.description("Test that url is saved as instance attribute.")
    ...
    @allure.title("Logger is bound with class name")
    @allure.description("Test that logger is bound with class name.")
    ...
    @allure.title("Initialization with empty string URL")
    @allure.description("Test initialization with empty string URL.")
    def test_init_with_empty_string_url(self, valid_config):
        """Test initialization with empty string URL."""
        with allure.step("Create BaseMiniApp instance with empty string URL"):
    ...
    @allure.title("Initialization with invalid URL type raises TypeError")
    @allure.description("Test initialization with invalid URL type raises TypeError.")
    def test_init_with_invalid_url_type(self, invalid_url, valid_config):
        ...
        with allure.step(
            f"Attempt to create BaseMiniApp with invalid URL type: {type(invalid_url).__name__}"
        ):
...
class TestBaseMiniAppContextManager:
    ...
    async def test_aexit_calls_close(self, mocker, valid_config):
        ...
        with allure.step("Create BaseMiniApp instance and mock close method"):
            app = BaseMiniApp("https://example.com/app", valid_config)
    ...
    @pytest.mark.asyncio
    @allure.title("__aexit__() does not suppress exceptions (default behavior)")
    @allure.description(
...
class TestBaseMiniAppClose:
    ...
    @pytest.mark.asyncio
    @allure.title("close() logs debug message")
    @allure.description("Test close() logs debug message.")
    ...
    @pytest.mark.asyncio
    @allure.title("close() does not raise exceptions by default")
    @allure.description("Test close() does not raise exceptions by default.")
    ...
    @pytest.mark.asyncio
    @allure.title("close() is safe to call multiple times")
    @allure.description("Test close() is safe to call multiple times.")
    ...
    @pytest.mark.asyncio
    @allure.title("close() can be overridden in subclasses")
    @allure.description("Test close() can be overridden in subclasses.")
...
class TestBaseMiniAppErrorHandling:
    ...
    @allure.title("Initialization with non-string URL raises TypeError")
    @allure.description(
    ...
    def test_init_with_non_string_url_raises_type_error(self, valid_config):
        """Test that initialization with non-string URL raises TypeError."""
        with allure.step("Attempt to create BaseMiniApp with non-string URL (int)"):
            with pytest.raises(TypeError, match="url must be a string"):
                BaseMiniApp(123, valid_config)  # type: ignore[arg-type]

    @allure.title("Initialization with list as URL raises TypeError")
    @allure.description("Test that initialization with list as URL raises TypeError.")
    def test_init_with_list_url_raises_type_error(self, valid_config):
        ...
        with allure.step("Attempt to create BaseMiniApp with list as URL"):
            with pytest.raises(TypeError, match="url must be a string"):
                BaseMiniApp([], valid_config)  # type: ignore[arg-type]

    @allure.title("Invalid config object raises error at Config creation")
    @allure.description(
    ...
    def test_init_with_invalid_config_object_raises_at_config_creation(self):
        """Test that invalid config object raises error at Config creation."""
        with allure.step("Attempt to create Config with invalid data and BaseMiniApp"):
...
class TestBaseMiniAppLogging:
    ...
    @allure.title("Logger is bound to class name")
    @allure.description("Test logger is bound to class name.")
    ...
    @allure.title("Logger in subclass uses subclass name")
    @allure.description("Test logger in subclass uses subclass name.")
    ...
    @pytest.mark.asyncio
    @allure.title("close() logs with proper context")
    @allure.description("Test close() logs with proper context.")
    ...
    @allure.title("Logger has name attribute (bound logger)")
    @allure.description("Test logger has name attribute (bound logger).")
...
class TestBaseMiniAppAdditional:
    ...
    @allure.title("URL attribute is accessible after initialization")
    @allure.description("Test url attribute is accessible after initialization.")
    ...
    @allure.title("Config attribute is accessible after initialization")
    @allure.description("Test config attribute is accessible after initialization.")
    ...
    @allure.title("Logger attribute is accessible after initialization")
    @allure.description("Test logger attribute is accessible after initialization.")
    ...
    @pytest.mark.asyncio
    @allure.title("Full lifecycle: init -> context manager -> close")
    @allure.description("Test full lifecycle: init -> context manager -> close.")
    async def test_full_lifecycle(self, valid_config):
        """Test full lifecycle: init -> context manager -> close."""
        with allure.step("Use BaseMiniApp as async context manager"):
            async with BaseMiniApp("https://example.com/app", valid_config) as app:
    ...
    @allure.title("Multiple instances are independent")
    @allure.description("Test multiple instances are independent.")
    def test_multiple_instances_independent(self, valid_config):
        """Test multiple instances are independent."""
        with allure.step("Create two BaseMiniApp instances with different URLs"):
