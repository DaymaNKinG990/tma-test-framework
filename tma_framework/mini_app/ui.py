...
class MiniAppUI(BaseMiniApp):
    ...
    async def get_element_attribute_value(self, selector: str, attribute: str) -> Optional[str]:
        """
        ...
        try:
            ...
            self.logger.error(f"Failed to get element attribute {selector}.{attribute}: {e}")
            return None
