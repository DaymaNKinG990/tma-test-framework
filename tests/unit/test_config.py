...
@mark.unit
@allure.title("Create valid configuration")
@allure.description("Test creating a valid configuration.")
...
@mark.unit
@allure.title("Create valid configuration with session file")
@allure.description("Test creating a valid configuration with session file.")
...
@mark.unit
@allure.title("Configuration default values")
@allure.description("Test configuration default values.")
...
@mark.unit
@allure.title("Configuration validation success")
@allure.description("Test successful configuration validation.")
...
@mark.unit
@allure.title("Configuration validation with missing api_id")
@allure.description("Test configuration validation with missing api_id.")
...
@mark.unit
@allure.title("Configuration validation with missing api_hash")
@allure.description("Test configuration validation with missing api_hash.")
...
@mark.unit
@allure.title("Configuration validation with missing session")
@allure.description("Test configuration validation with missing session.")
...
@mark.unit
@allure.title("Configuration validation with invalid log level")
@allure.description("Test configuration validation with invalid log level.")
...
@mark.unit
@allure.title("Configuration validation with invalid retry count")
@allure.description("Test configuration validation with invalid retry count.")
...
@mark.unit
@allure.title("Configuration validation with invalid retry delay")
@allure.description("Test configuration validation with invalid retry delay.")
...
@mark.unit
@allure.title("Configuration validation with minimal values")
@allure.description("Test configuration validation with minimal values.")
...
@mark.unit
@allure.title("Configuration validation with maximal values")
@allure.description("Test configuration validation with maximal values.")
...
@mark.unit
@allure.title("Configuration validation with invalid api_id")
@allure.description("Test configuration validation with invalid api_id.")
...
@mark.unit
@allure.title("Configuration validation with invalid minimal retry count")
@allure.description("Test configuration validation with invalid minimal retry count.")
...
@mark.unit
@allure.title("Configuration validation with invalid minimal retry delay")
@allure.description("Test configuration validation with invalid minimal retry delay.")
...
@mark.unit
@allure.title("Configuration validation with invalid timeout")
@allure.description("Test configuration validation with invalid timeout.")
...
@mark.unit
@allure.title("Configuration validation with invalid maximal retry count")
@allure.description("Test configuration validation with invalid maximal retry count.")
...
@mark.unit
@allure.title("Configuration validation with invalid maximal retry delay")
@allure.description("Test configuration validation with invalid maximal retry delay.")
...
@mark.unit
@allure.title("Configuration serialization")
@allure.description("Test configuration serialization.")
...
@mark.unit
@allure.title("Configuration deserialization")
@allure.description("Test configuration deserialization.")
...
@mark.unit
@allure.title("Configuration equality with same data")
@allure.description("Test configuration equality with same data.")
...
@mark.unit
@allure.title("Configuration inequality with different data")
@allure.description("Test configuration inequality with different data.")
...
@mark.unit
@allure.title("Configuration hash equality with same data")
@allure.description("Test configuration hash equality with same data.")
...
@mark.unit
@allure.title("Configuration hash inequality with different data")
@allure.description("Test configuration hash inequality with different data.")
...
@mark.unit
@allure.title("Configuration string representation")
@allure.description("Test configuration string representation.")
...
@mark.unit
@allure.title("Create config from valid environment variables")
@allure.description("Test creating config from valid environment variables.")
...
@mark.unit
@allure.title("Create config with missing required environment variables")
@allure.description("Test creating config with missing required environment variables.")
...
@mark.unit
@allure.title("Create config with missing TMA_API_ID")
@allure.description("Test creating config with missing TMA_API_ID.")
...
@mark.unit
@allure.title("Create config with missing TMA_API_HASH")
@allure.description("Test creating config with missing TMA_API_HASH.")
...
@mark.unit
@allure.title("Create config with invalid TMA_API_ID")
@allure.description("Test creating config with invalid TMA_API_ID.")
...
@mark.unit
@allure.title("Create config with default values from environment")
@allure.description("Test creating config with default values from environment.")
...
@mark.unit
@allure.title("Create config with overridden default values")
@allure.description("Test creating config with overridden default values.")
...
@mark.unit
@allure.title("Create config with optional environment variables")
@allure.description(
    "Test creating config with optional environment variables. Both session_string and session_file are set, which should raise ValueError."
)
...
@mark.unit
@allure.title("Type conversion in from_env method")
@allure.description("Test type conversion in from_env method.")
...
@mark.unit
@allure.title("Invalid type conversion in from_env method")
@allure.description("Test invalid type conversion in from_env method.")
...
@mark.unit
@allure.title("from_env method with missing session string")
@allure.description("Test from_env method with missing session string.")
...
@mark.unit
@allure.title("from_env method with invalid TMA_API_ID")
@allure.description("Test from_env method with invalid TMA_API_ID.")
...
@mark.unit
@allure.title("from_env method with invalid TMA_API_HASH length")
@allure.description("Test from_env method with invalid TMA_API_HASH length.")
...
@mark.unit
@allure.title("Configuration with empty strings")
@allure.description("Test configuration with empty strings.")
...
@mark.unit
@allure.title("Configuration with whitespace strings")
@allure.description("Test configuration with whitespace strings.")
...
@mark.unit
@allure.title("Configuration with very long strings")
@allure.description("Test configuration with very long strings.")
def test_config_with_very_long_strings(
    ...
    with allure.step("Verify very long session_string is handled"):
        assert (
            config.session_string == config_data_for_very_long_strings["session_string"]
        )


@mark.unit
@allure.title("Configuration with special characters")
@allure.description("Test configuration with special characters.")
...
@mark.unit
@allure.title("Configuration with unicode characters")
@allure.description("Test configuration with unicode characters.")
...
@mark.unit
@allure.title("Configuration with None values")
@allure.description("Test configuration with None values.")
...
@mark.unit
@allure.title("Configuration with both session_string and session_file")
@allure.description(
...
@mark.unit
@allure.title("Configuration mini_app_url with whitespace")
@allure.description(
...
@mark.unit
@allure.title("Configuration log level debug")
@allure.description("Test configuration log level debug.")
...
@mark.unit
@allure.title("Configuration log level info")
@allure.description("Test configuration log level info.")
...
@mark.unit
@allure.title("Configuration log level warning")
@allure.description("Test configuration log level warning.")
...
@mark.unit
@allure.title("Configuration log level error")
@allure.description("Test configuration log level error.")
...
@mark.unit
@allure.title("Configuration log level critical")
@allure.description("Test configuration log level critical.")
...
@mark.unit
@allure.title("Log level case sensitivity")
@allure.description("Test log level case sensitivity.")
...
@mark.unit
@allure.title("Float precision in retry_delay")
@allure.description("Test float precision in retry_delay.")
...
@mark.unit
@allure.title("Configuration with large numbers")
@allure.description("Test configuration with large numbers.")
...
@mark.unit
@allure.title("Create config from valid YAML file")
@allure.description("Test creating config from valid YAML file.")
...
@mark.unit
@allure.title("Create config from minimal YAML file")
@allure.description("Test creating config from minimal YAML file.")
...
@mark.unit
@allure.title("Create config from YAML file with session_file")
@allure.description("Test creating config from YAML file with session_file.")
...
@mark.unit
@allure.title("Create config from YAML file with mini app settings")
@allure.description("Test creating config from YAML file with mini app settings.")
def test_from_yaml_with_mini_app(
    ...
    with allure.step("Verify all values from YAML with mini app are loaded correctly"):
...
@mark.unit
@allure.title("Create config from invalid YAML file")
@allure.description("Test creating config from invalid YAML file.")
...
@mark.unit
@allure.title("Create config from YAML file missing session")
@allure.description("Test creating config from YAML file missing session.")
...
@mark.unit
@allure.title("Create config from nonexistent YAML file")
@allure.description("Test creating config from nonexistent YAML file.")
...
@mark.unit
@allure.title("Create config from YAML file with invalid format")
@allure.description("Test creating config from YAML file with invalid format.")
...
@mark.unit
@allure.title("Create config from empty YAML file")
@allure.description("Test creating config from empty YAML file.")
...
@allure.title("Valid api_id values")
@allure.description("Test valid api_id values.")
...
@allure.title("Invalid api_id values")
@allure.description("Test invalid api_id values.")
...
@allure.title("Valid api_hash length")
@allure.description("Test valid api_hash length.")
...
@allure.title("Invalid api_hash length")
@allure.description("Test invalid api_hash length.")
...
@mark.unit
@allure.title("api_hash with None value")
@allure.description("Test api_hash with None value.")
...
@allure.title("Valid timeout values")
@allure.description("Test valid timeout values.")
...
@allure.title("Invalid timeout values")
@allure.description("Test invalid timeout values.")
...
@allure.title("Valid retry_count values")
@allure.description("Test valid retry_count values.")
...
@allure.title("Invalid retry_count values")
@allure.description("Test invalid retry_count values.")
...
@allure.title("Valid retry_delay values")
@allure.description("Test valid retry_delay values.")
...
@allure.title("Invalid retry_delay values")
@allure.description("Test invalid retry_delay values.")
...
@allure.title("Valid log_level values")
@allure.description("Test valid log_level values.")
...
@allure.title("Invalid log_level values")
@allure.description("Test invalid log_level values.")
...
@allure.title("Empty or whitespace-only session_string")
@allure.description("Test empty or whitespace-only session_string.")
def test_config_empty_whitespace_session_string(session_string: str) -> None:
    """Test empty or whitespace-only session_string."""
    with allure.step("Attempt to create Config with empty/whitespace session_string"):
        with raises(
            ValueError,
            match="session_string cannot be empty or contain only whitespace",
        ):
...
@allure.title("Empty or whitespace-only session_file")
@allure.description("Test empty or whitespace-only session_file.")
...
@mark.unit
@allure.title("Frozen config raises AttributeError on attribute modification")
@allure.description(
...
@mark.unit
@allure.title("from_env with missing TMA_API_ID only")
@allure.description("Test from_env with missing TMA_API_ID only.")
...
@mark.unit
@allure.title("from_env with missing TMA_API_HASH only")
@allure.description("Test from_env with missing TMA_API_HASH only.")
...
@mark.unit
@allure.title("from_env with empty TMA_API_ID")
@allure.description("Test from_env with empty TMA_API_ID.")
...
@mark.unit
@allure.title("from_env with non-numeric TMA_API_ID")
@allure.description("Test from_env with non-numeric TMA_API_ID.")
...
@mark.unit
@allure.title("from_env with non-numeric TMA_TIMEOUT")
@allure.description("Test from_env with non-numeric TMA_TIMEOUT.")
...
@mark.unit
@allure.title("from_env with non-numeric TMA_RETRY_DELAY")
@allure.description("Test from_env with non-numeric TMA_RETRY_DELAY.")
...
@mark.unit
@allure.title("from_env with whitespace-only TMA_SESSION_STRING")
@allure.description("Test from_env with whitespace-only TMA_SESSION_STRING.")
...
@mark.unit
@allure.title("from_env uses default values when optional env vars are missing")
@allure.description(
...
@mark.unit
@allure.title("from_env with whitespace-only TMA_SESSION_FILE")
@allure.description("Test from_env with whitespace-only TMA_SESSION_FILE.")
...
@mark.unit
@allure.title("from_yaml with null optional fields in YAML")
@allure.description("Test from_yaml with null optional fields in YAML.")
...
@mark.unit
@allure.title("from_yaml with minimum boundary values")
@allure.description("Test from_yaml with minimum boundary values.")
...
@mark.unit
@allure.title("from_yaml with maximum boundary values")
@allure.description("Test from_yaml with maximum boundary values.")
...
@mark.unit
@allure.title("from_yaml with missing api_id in YAML")
@allure.description("Test from_yaml with missing api_id in YAML.")
...
@mark.unit
@allure.title("from_yaml with api_id = 0 in YAML")
@allure.description("Test from_yaml with api_id = 0 in YAML.")
...
@mark.unit
@allure.title("from_yaml with lowercase log_level in YAML")
@allure.description("Test from_yaml with lowercase log_level in YAML.")
...
@mark.unit
@allure.title("from_yaml overrides api_hash with TMA_API_HASH env variable")
@allure.description(
...
@mark.unit
@allure.title("from_yaml overrides session_string with TMA_SESSION_STRING env variable")
@allure.description(
...
@mark.unit
@allure.title("from_yaml overrides session_file with TMA_SESSION_FILE env variable")
@allure.description(
...
"""
    ...
    try:
        ...
        with allure.step("Verify session_file is from environment variable, not YAML"):
            ...
            assert (
                config.session_string is None or config.session_string != "old_session"
            )
    finally:
        os.unlink(temp_path)
...
@mark.unit
@allure.title("Config serialization using msgspec.to_builtins")
@allure.description("Test serialization using msgspec.to_builtins.")
...
@mark.unit
@allure.title("Config deserialization from dict using msgspec.convert")
@allure.description("Test deserialization using msgspec.convert.")
...
@mark.unit
@allure.title("Config repr contains class name")
@allure.description("Test that Config repr contains class name.")
